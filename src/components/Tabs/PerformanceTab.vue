<template>
	<div v-show="active">
		...
		<div tabs="performance">
			...
			<timeline name="performance" :timeline="$request.timeline" :tags="timelineTags" :start-time="$request.time" :end-time="$request.time + $request.responseDuration" v-show="isTabActive('timeline')"></timeline>
